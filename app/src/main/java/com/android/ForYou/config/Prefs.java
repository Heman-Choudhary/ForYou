package com.android.ForYou.config;

import android.content.Context;
import android.content.SharedPreferences;

import com.android.ForYou.BuildConfig;
import com.android.ForYou.ForYou;

@SuppressWarnings("unused")
public class Prefs {

    public static SharedPreferences prefs = ForYou.getAppContext().getSharedPreferences(BuildConfig.APPLICATION_ID, Context.MODE_PRIVATE);
